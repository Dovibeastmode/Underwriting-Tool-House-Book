...
| Path | What it is |
|---|---|
| `Aspire_Combined_Underwriting_Model_v2_DEMO.xlsx` | **Current working version, demo data**: 8 sample deals, Deal sheet populated, history can loosen sizing (see `docs/04_v2_Changes.md`). |
| `Aspire_Combined_Underwriting_Model_v2.xlsx` | Same v2 model on the full 1,067-deal book, blank Deal sheet. |
