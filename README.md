...
| Path | What it is |
|---|---|
| `Aspire_Combined_Underwriting_Model_v3_DEMO.xlsx` | **Current working version, demo data**: 8 sample deals, Deal sheet populated. No credibility/blend/seq/state; Historical Score reduced to tier, cohort, seasoned n, funded, meets min, PLR, ROF, index (see `docs/04_v2_Changes.md`). |
| `Aspire_Combined_Underwriting_Model_v3.xlsx` | Same v3 model on the full 1,067-deal book, blank Deal sheet. |
